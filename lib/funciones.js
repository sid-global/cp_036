...
function cargarEstProy_proy(){
	...
	html_g += '</div></div><div data-role="controlgroup" data-type="horizontal" align="center"><a onclick="window.open(\'ZzzPrueba.html\',\'nuevaVentana\',\'width=1000, height=800\')" data-role="button" data-theme="b">Graficos</a></div>)';
...
function cargarEstTarea_proy(){
	...
	// ------------- GRAFICO: Rendimiento ------------ //	
		// -- Editable --	
		var rendimiento = elemento.rendimiento
		var limite_rojo = 40
	...
	// ------------- GRAFICO: Gauge - DR ------------ //		
		...
		// -- Editable --
		var dir_aguja = elemento.dr
		var limite_max = 0
		
		if(elemento.dr<=50){		
			limite_max = 50
		}else{
			limite_max = elemento.dr
		}
		// -- Fin editable --
	...
	// ------------- Grafico reloj - Balance de Horas ------------ //
		...
		// -- Editable --
		var limite_verde = elemento.hp       // HP
		var limite_amarillo = elemento.hpex  // HPex
		var limite_rojo = elemento.hpex+20   // Sobre tiempo
		var dir_aguja = elemento.hc			 // HC
		// -- Fin editable --
		
		var r1 = new RGraph.Meter('bt_Reloj', 0,limite_rojo,dir_aguja);
        r1.Set('chart.colors.ranges', [[0,limite_verde, RGraph.RadialGradient(r1, 200,175,70,200,175,20, 'green', 'white')],[limite_verde,limite_amarillo, RGraph.RadialGradient(r1, 200,175,70,200,175,20, 'yellow', 'white')], [limite_amarillo,limite_rojo, RGraph.RadialGradient(r1, 200,175,70,200,175,20, 'red', 'white')]]);
        r1.Draw();
